...
namespace Store.Data.Migrations
{
    ...
    [Migration("20201218124253_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Data.Entity.Category", b =>
                {
                    ...
                    b.Property<int>("BrandCategoryForienKey")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TaxCategoryForienKey")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BrandCategoryForienKey");

                    b.HasIndex("CategoryImageId");

                    b.HasIndex("ProductId");

                    b.HasIndex("TaxCategoryForienKey");
            ...
            modelBuilder.Entity("Store.Data.Entity.CategoryImage", b =>
                {
                    ...
                    b.Property<int>("CategoryForienKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Data.Entity.Product", b =>
                {
                    ...
                    b.Property<int>("BrandProductForienKey")
                        .HasColumnType("int");

                    b.Property<int>("CategoryId")
                        .HasColumnType("int");

                    b.Property<int>("CategoryProductForienKey")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TaxProductForienKey")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BrandProductForienKey");

                    b.HasIndex("CategoryProductForienKey");

                    b.HasIndex("ProductImageId");

                    b.HasIndex("TaxProductForienKey");
            ...
            modelBuilder.Entity("Store.Data.Entity.Category", b =>
                {
                    b.HasOne("Store.Data.Entity.Brand", "Brand")
                        .WithMany("CategoryList")
                        .HasForeignKey("BrandCategoryForienKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Store.Data.Entity.TaxMaster", "TaxMaster")
                        .WithMany("CategoryList")
                        .HasForeignKey("TaxCategoryForienKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Store.Data.Entity.CategoryImage", b =>
                {
                    b.HasOne("Store.Data.Entity.Category", "Category")
                        .WithOne("CategoryImage")
                        .HasForeignKey("Store.Data.Entity.CategoryImage", "CategoryForienKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Store.Data.Entity.Product", b =>
                {
                    b.HasOne("Store.Data.Entity.Brand", "Brand")
                        ...
                        .HasForeignKey("BrandProductForienKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Store.Data.Entity.Category", "Category")
                        .WithMany("ProductList")
                        .HasForeignKey("CategoryProductForienKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("Store.Data.Entity.TaxMaster", "TaxMaster")
                        .WithMany("ProductList")
                        .HasForeignKey("TaxProductForienKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Store.Data.Entity.ProductImage", b =>
                {
                    b.HasOne("Store.Data.Entity.Product", "Product")
                        ...
                        .HasForeignKey("Store.Data.Entity.ProductImage", "ProductForienKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
